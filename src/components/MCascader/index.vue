<template>
  <el-cascader v-model="formItemVal" :style="widths" :options="optionsVal" :placeholder="itemConfig.placeholder || placeholder" :disabled="disabled" filterable clearable @focus="getOptions()" @change="handleChange" />
</template>
